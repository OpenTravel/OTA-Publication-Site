...
public abstract class AbstractDAO {
	 ...
	 * 
	 * @param contentBytes  the byte array content of the new file object
	 * @return FileContent
	 * @throws IOException  thrown if an error occurs while attempting to read from the given input stream
	 */
	protected FileContent persistFileContent(byte[] contentBytes) throws IOException {
		return persistFileContent( new ByteArrayInputStream( contentBytes ) );
	}
