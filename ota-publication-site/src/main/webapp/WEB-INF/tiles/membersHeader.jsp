...
<div id="header" class="clear">
	...
	<ul id="superNav">
		<li><a href="${config.localSiteUrl}/specifications/members/Specifications.html" class="buttonBlue"><span>download specs</span></a></li>
	...
	<ul id="mainNav">
		...
		<li><a href="${config.localSiteUrl}/specifications/members/Specifications.html">member-review specifications</a></li>
		<li></li>
	</ul>
</div>
