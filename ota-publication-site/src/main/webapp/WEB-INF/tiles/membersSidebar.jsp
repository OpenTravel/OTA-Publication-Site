			...
			<c:choose>
				<c:when test="${(currentPage == 'specification10MainMembers') || ((currentPage == 'specificationReleaseNotesMembers') && (publication.type == 'OTA_1_0'))}">
					<a id="SideNavControl1_MenuHyperLink" class="current"
						href="${config.localSiteUrl}/specifications/members/Specifications.html">1.0 Specification</a>
				</c:when>
				<c:otherwise>
			...
			<c:choose>
				<c:when test="${(currentPage == 'specification20MainMembers') || ((currentPage == 'specificationReleaseNotesMembers') && (publication.type == 'OTA_2_0'))}">
					<a id="SideNavControl1a_MenuHyperLink" class="current"
						href="${config.localSiteUrl}/specifications/members/Specifications20.html">2.0 Specification</a>
				</c:when>
				<c:otherwise>
			...
			<c:choose>
				<c:when test="${currentPage == 'specificationComment10Members'}">
					<a id="SideNavControl2_MenuHyperLink" class="current"
						href="${config.localSiteUrl}/specifications/members/Comment10Spec.html">Comment on 1.0 Specification</a>
				</c:when>
				<c:otherwise>
			...
			<c:choose>
				<c:when test="${currentPage == 'artifactComment10Members'}">
					<a id="SideNavControl3_MenuHyperLink" class="current"
						href="${config.localSiteUrl}/specifications/members/Comment10Artifact.html">Comment on 1.0 Artifact</a>
				</c:when>
				<c:otherwise>
			...
			<c:choose>
				<c:when test="${currentPage == 'specificationComment20Members'}">
					<a id="SideNavControl4_MenuHyperLink" class="current"
						href="${config.localSiteUrl}/specifications/members/Comment20Spec.html">Comment on 2.0 Specification</a>
				</c:when>
				<c:otherwise>
			...
			<c:choose>
				<c:when test="${currentPage == 'artifactComment20Members'}">
					<a id="SideNavControl5_MenuHyperLink" class="current"
						href="${config.localSiteUrl}/specifications/members/Comment20Artifact.html">Comment on 2.0 Artifact</a>
				</c:when>
				<c:otherwise>
