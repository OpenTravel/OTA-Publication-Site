...
/**
 * Controller that handles interactions with the publication pages of the OpenTravel specification site.
 * 
 * @author S. Livezey
 */
@Controller
...
public class PublicationController extends BaseController {
    ...
    @RequestMapping({"/Specifications10.html", "/Specifications10.htm"})
    public String specifications10PublicPage(Model model, HttpSession session,
        ...
        return doSpecificationPage( model, session, spec, newSession, specificationForm, PublicationType.OTA_1_0, false,
            "specification10Main", "Specifications10.html" );
    }

    @RequestMapping({"/Specifications.html", "/Specifications.htm", "/Specifications20.html", "/Specifications20.htm"})
    public String specifications20PublicPage(Model model, HttpSession session,
        @RequestParam(value = "spec", required = false) String spec,
        @RequestParam(value = "newSession", required = false) boolean newSession,
        @ModelAttribute("specificationForm") ViewSpecificationForm specificationForm) {

        return doSpecificationPage( model, session, spec, newSession, specificationForm, PublicationType.OTA_2_0, false,
            "specification20Main", "Specifications20.html" );
    }

    @RequestMapping({"/members/Specifications10.html", "/members/Specifications10.htm"})
    public String specifications10MemberPage(Model model, HttpSession session,
        @RequestParam(value = "spec", required = false) String spec,
        @RequestParam(value = "newSession", required = false) boolean newSession,
        @ModelAttribute("specificationForm") ViewSpecificationForm specificationForm) {

        return doSpecificationPage( model, session, spec, newSession, specificationForm, PublicationType.OTA_1_0, true,
            "specification10MainMembers", "members/Specifications10.html" );
    }

    @RequestMapping({"/members/Specifications.html", "/members/Specifications.htm", "/members/Specifications20.html",
        "/members/Specifications20.htm"})
    public String specifications20MemberPage(Model model, HttpSession session,
        @RequestParam(value = "spec", required = false) String spec,
        @RequestParam(value = "newSession", required = false) boolean newSession,
        @ModelAttribute("specificationForm") ViewSpecificationForm specificationForm) {

        return doSpecificationPage( model, session, spec, newSession, specificationForm, PublicationType.OTA_2_0, true,
            "specification20MainMembers", "members/Specifications20.html" );
    }
    ...
    public String comment10SpecMemberPage(Model model, HttpSession session, RedirectAttributes redirectAttrs,
        ...
        return doCommentSpecPage( model, session, redirectAttrs, newSession, commentForm, PublicationType.OTA_1_0, true,
            "specificationComment10Members", "/specifications/members/Comment10Spec.html" );
    }
    ...
    public String comment20SpecMemberPage(Model model, HttpSession session, RedirectAttributes redirectAttrs,
        ...
        return doCommentSpecPage( model, session, redirectAttrs, newSession, commentForm, PublicationType.OTA_2_0, true,
            "specificationComment20Members", "/specifications/members/Comment20Spec.html" );
    }
    ...
    public String comment10ArtifactPublicPage(Model model, HttpSession session, RedirectAttributes redirectAttrs,
        ...
        return doCommentArtifactPage( model, session, redirectAttrs, newSession, commentForm, PublicationType.OTA_1_0,
            false, "artifactComment10", "/specifications/Comment10Artifact.html" );
    }
    ...
    public String comment20ArtifactPublicPage(Model model, HttpSession session, RedirectAttributes redirectAttrs,
        ...
        return doCommentArtifactPage( model, session, redirectAttrs, newSession, commentForm, PublicationType.OTA_2_0,
            false, "artifactComment20", "/specifications/Comment20Artifact.html" );
    }
    ...
    public String comment10ArtifactMemberPage(Model model, HttpSession session, RedirectAttributes redirectAttrs,
        ...
        return doCommentArtifactPage( model, session, redirectAttrs, newSession, commentForm, PublicationType.OTA_1_0,
            true, "artifactComment10Members", "/specifications/members/Comment10Artifact.html" );
    }
    ...
    public String comment20ArtifactMemberPage(Model model, HttpSession session, RedirectAttributes redirectAttrs,
        ...
        return doCommentArtifactPage( model, session, redirectAttrs, newSession, commentForm, PublicationType.OTA_2_0,
            true, "artifactComment20Members", "/specifications/members/Comment20Artifact.html" );
    }
            ...
            if (vResults.hasViolations()) {
                ...
                try {
                    ...
                    InternetAddress recipient =
                        new InternetAddress( emailConfig.getProperty( EmailConfigBuilder.SENDER_ADDRESS_PROPERTY ),
    ...
    public String downloadPublicationNoRegistration(Model model, HttpSession session, HttpServletRequest request,
        ...
        try {
            ...
            targetPath = doPublicationDownload( model, session, registrant, request, response, redirectAttrs, pubName,
                type, filename );
    ...
    /**
     * Performs a download of the publication or publication item content specified by the URL parameters.
     * 
    ...
    protected String doPublicationDownload(Model model, HttpSession session, Registrant registrant,
        HttpServletRequest request, HttpServletResponse response, RedirectAttributes redirectAttrs, String pubName,
        String type, String filename) throws DAOException, IOException {
    ...
    private String doSpecificationPage(Model model, HttpSession session, String spec, boolean newSession,
        ViewSpecificationForm specificationForm, PublicationType pubType, boolean isMembersOnlyPage, String targetPage,
        String altPageLocation) {
        try {
            RegistrantForm registrantForm = specificationForm.getRegistrantForm();
            PublicationDAO pDao = DAOFactoryManager.getFactory().newPublicationDAO();
            ...
            model.addAttribute( "releaseNotesUrl",
                isMembersOnlyPage ? "/specifications/members/ReleaseNotes.html" : "/specifications/ReleaseNotes.html" );
            ...
            // attributes will not show up as URL parameters on redirect
            if (registrantForm.isProcessForm() && (model.asMap().get( "registrant" ) != null)) {
                targetPage = "redirect:/specifications/" + altPageLocation + ((spec == null) ? "" : "?spec=" + spec);
                model.asMap().clear();
            }
            specificationForm.setProcessForm( true );
     ...
     * @return String
     */
    private String doReleaseNotesPage(Model model, HttpSession session, String spec, String specType, String targetPage,
        boolean isMembersOnlyPage) {
        try {
            PublicationDAO pDao = DAOFactoryManager.getFactory().newPublicationDAO();
            PublicationType pubType = resolvePublicationType( specType );
            Publication publication = pDao.getPublication( spec, pubType );
    ...
    /**
     * Returns an array of allowed publication states depending upon whether the desired viewing should be publicly
     * available or a members-only.
     * 
    ...
    /**
     * Removes all publications assigned to the <code>MEMBER_REVIEW</code> state from the given list.
     * 
    ...
    /**
     * Creates, retrieves, or updates the current/new registrant. If no registration has been created or a validation
     * error occurs while attempting to create one, this method will return null.
     * 
    ...
    private boolean addSchemaComment(SchemaCommentForm commentForm, Registrant registrant, Model model,
        ...
        try {
            PublicationItem item =
                (commentForm.getItemId() == null) ? null : pDao.getPublicationItem( commentForm.getItemId() );
    ...
    /**
     * Returns the text of the release notes, or an empty string if they cannot be retrieved.
     * 
